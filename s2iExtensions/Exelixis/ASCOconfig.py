...
WEBSITE_CONFIG = {
    'asco': {
        ...
        'presentaion_section': "//div[contains(@id, 'presentation')]",  # XPath for presentation sections
        'presentaiontime_xpath': "//div[@class='presentation-time small ng-star-inserted']",  # XPath for presentation times
